...
function setupSmartTools() {
  document.querySelectorAll(".mini-theme").forEach((button) => button.addEventListener("click", () => {
...
function applyDashboardTheme() {
  document.body.dataset.theme = state.theme || "clean";
  document.querySelectorAll(".mini-theme").forEach((button) => button.classList.toggle("active", button.dataset.theme === state.theme));
}
